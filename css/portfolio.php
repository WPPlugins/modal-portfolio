...
$fontSizeFiltre = get_option("modal_portfolio_fontSizeFilter");
...
$paddingFiltres = get_option("modal_portfolio_paddingFilter");
...
/* Rendu des filtres */
#filters {text-align:center; font-size:<?php echo $fontSizeFiltre; ?>}
#filters .button{margin:<?php echo $margeFiltres; ?>; background-color:<?php echo $bgcouleurFiltre; ?>; border:<?php echo $widthFiltreBorder."px ".$styleFiltreBorder." ".$couleurFiltreBorder; ?>; <?php echo $typeCoins; ?> color:<?php echo $couleurFiltre; ?>; cursor:pointer; display:inline-block; padding:<?php echo $paddingFiltres; ?>; -webkit-transition:all 400ms linear; -moz-transition:all 400ms linear; -ms-transition:all 400ms linear; -o-transition:all 400ms linear; transition:all 400ms linear}
