...
function modal_portfolio_installation() {
	...
	add_option("modal_portfolio_thumbnail_default", true);
	...
	add_option("modal_portfolio_fontSizeFilter", ".9em");
	...
	add_option("modal_portfolio_paddingFilter", ".3em 1em");
...
function modal_portfolio_desinstallation() {
	...
	delete_option("modal_portfolio_thumbnail_default");
	...
	delete_option("modal_portfolio_fontSizeFilter");
	...
	delete_option("modal_portfolio_paddingFilter");
...
function modal_portfolio_upgrade() {
    ...
    if(get_site_option('modal_portfolio_version') != $modal_portfolio_version) {
		...
		if(!get_option('modal_portfolio_widthModal')) {
			update_option("modal_portfolio_thumbnail_default", true);
		}
		// Nouvelles données v1.6
		if(!get_option('modal_portfolio_fontSizeFilter')) {
			update_option("modal_portfolio_fontSizeFilter", ".9em");
			update_option("modal_portfolio_paddingFilter", ".3em 1em");
		}
...
function modal_portfolio_scripts() {
    wp_enqueue_script('isotope', plugins_url().'/modal-portfolio/js/isotope.min.js', array('jquery'), '3.0.4', true);
    wp_enqueue_script('image-loaded', plugins_url().'/modal-portfolio/js/imagesloaded.min.js', array('jquery'), '4.1.2', true);
    ...
    wp_enqueue_script('portfolio-script', plugins_url('/modal-portfolio/js/portfolio.min.js', dirname(__FILE__)), array('jquery'), '1.0', true);
